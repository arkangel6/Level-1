...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.setName("framme");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel fra = new JPanel();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed==firstButton){
			...
			askQuestion("What color is a giraffe","yellow", 200);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What color is a polar bear", "white", 400);
		...
		// Clear the button text (set the button text to nothing)
			...
			// Call the askQuestion() method with a harder question
			askQuestion("What color is a elephant", "gray", 600);
		...
		// Clear the button text (set the button text to nothing)
			...
			// Call the askQuestion() method with a harder question
			askQuestion("What color is a unicorn", "rainbow", 800);
