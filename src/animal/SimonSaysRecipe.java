...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
  	//images.put(new Integer(KeyEvent.VK_S), "images.jpg");
  	//images.put(new Integer(KeyEvent.VK_B), "B-key-image.jpg");
  	//images.put(new Integer(KeyEvent.VK_DOWN), "computer_key_Arrow_Left.png");
  	images.put(new Integer(KeyEvent.VK_UP), "download.jpg");
